...
<ResponseField name="controlsContainer" type="HTMLElement | undefined">
...
<ResponseField name="displayIndex" type="number" required>
...
<ResponseField name="pages" type="number | undefined">
...
<ResponseField name="pagesCached" type="number | undefined">
...
<ResponseField name="sheet" type="CSSStyleSheet" required>
...
<ResponseField name="isOn" type="boolean" required>
